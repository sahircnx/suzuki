...
/**
 * Transformer: marutisuzuki section breaks and Section Metadata.
 * Inserts <hr> before each non-first section and a Section Metadata block
 * for each section with a style, using payload.template.sections.
 *
 * Section selectors come from page-templates.json (DOM-verified during
 * page analysis). Breaks are inserted in beforeTransform (while section
 * elements still exist) with a marker; metadata is anchored to that marker
 * in afterTransform. See generate-import-transformer.md ("Why both hooks").
 */
